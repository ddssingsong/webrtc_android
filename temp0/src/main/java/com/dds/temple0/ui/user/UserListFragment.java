...
public class UserListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.temp0_fragment_user, container, false);
        initView(root);
        initData();
        return root;
    }
    ...
    private class UserAdapter extends RecyclerView.Adapter<Holder> {
        ...
        public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getContext()).inflate(R.layout.temp0_item_list_users, parent, false);
        ...
        public void onBindViewHolder(@NonNull Holder holder, int position) {
            ...
            holder.text.setText(userBean.getUserId());
