...
public class RoomFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.temp0_fragment_room, container, false);
        initView(root);
        initData();
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.temp0_menu_room, menu);
    }
...
//                    "room-" + UUID.randomUUID().toString().substring(0, 16), true);
    ...
    private class RoomAdapter extends RecyclerView.Adapter<Holder> {
        ...
        public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getContext()).inflate(R.layout.temp0_item_list_rooms, parent, false);
