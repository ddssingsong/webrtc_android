...
import com.dds.rtc_chat.engine.IEngine;
import com.dds.rtc_chat.log.RTCLog;
import com.dds.rtc_chat.render.ProxyVideoSink;
...
public class WebRTCEngine implements IEngine, Peer.IPeerEvent {
    private final static String TAG = RTCLog.createTag(WebRTCEngine.class.getSimpleName());
